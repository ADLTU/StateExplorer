...
const Map = () =>{
    ...
    <div>
        ...
        <svg className="mapSVG" width="959" height="593">

            <g className="state" >
                 <Link to={"stateInformation/Alabama"} state={{stt: "Alabama"}}>
            <path className="al"
            ...
            <path className="tn"
             ...
             <Link to={"stateInformation/Texas"} state={{stt: "Texas"}}>
            <path className="tx"
